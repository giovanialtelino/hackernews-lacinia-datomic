...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__61671_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__61671_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61670_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__61670_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__61673_SHARP_){
return (((p1__61673_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__61673_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__61679,mapping){
...
var state = map__61680__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61680__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61680__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61680__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__61677_SHARP_){
if((p1__61677_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__61677_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__61759 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__61760 = clojure.zip.next(loc);
loc = G__61760;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__61691){
var vec__61692 = p__61691;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61692,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq61689){
var G__61690 = cljs.core.first(seq61689);
var seq61689__$1 = cljs.core.next(seq61689);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61690,seq61689__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__61695_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__61695_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__61698_61783 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__61699_61784 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__61700_61785 = true;
var _STAR_print_fn_STAR__temp_val__61701_61786 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__61700_61785);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__61701_61786);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__61699_61784);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__61698_61783);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__61696_SHARP_){
return debux.common.util.prepend_bars(p1__61696_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__61789 = cljs.core.next(opts__$1);
var G__61790 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__61789;
acc = G__61790;
continue;
} else {
if(typeof f === 'string'){
var G__61791 = cljs.core.next(opts__$1);
var G__61792 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__61791;
acc = G__61792;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__61793 = cljs.core.nnext(opts__$1);
var G__61794 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__61793;
acc = G__61794;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__61795 = cljs.core.next(opts__$1);
var G__61796 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__61795;
acc = G__61796;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__61720 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__61720.cljs$core$IFn$_invoke$arity$1 ? fexpr__61720.cljs$core$IFn$_invoke$arity$1(f) : fexpr__61720.call(null,f));
})())){
var G__61802 = cljs.core.next(opts__$1);
var G__61803 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__61802;
acc = G__61803;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__61722 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__61722.cljs$core$IFn$_invoke$arity$1 ? fexpr__61722.cljs$core$IFn$_invoke$arity$1(f) : fexpr__61722.call(null,f));
})())){
var G__61805 = cljs.core.nnext(opts__$1);
var G__61806 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__61805;
acc = G__61806;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__61807 = cljs.core.next(opts__$1);
var G__61808 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__61807;
acc = G__61808;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__61723){
var vec__61724 = p__61723;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61724,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61724,(1),null);
...
var G__61735 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__61734 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__61743 = quoted_form;
var G__61744 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__61743,G__61744) : debux.common.util.remove_d.call(null,G__61743,G__61744));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__61745 = quoted_form;
var G__61746 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__61745,G__61746) : debux.common.util.remove_d.call(null,G__61745,G__61746));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__61816__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__61747 = quoted_form;
var G__61748 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__61747,G__61748) : debux.common.util.remove_d.call(null,G__61747,G__61748));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__61817__i < G__61817__a.length) {G__61817__a[G__61817__i] = arguments[G__61817__i + 0]; ++G__61817__i;}
  arg = new cljs.core.IndexedSeq(G__61817__a,0,null);
} 
return G__61816__delegate.call(this,arg);};
G__61816.cljs$lang$maxFixedArity = 0;
G__61816.cljs$lang$applyTo = (function (arglist__61818){
var arg = cljs.core.seq(arglist__61818);
return G__61816__delegate(arg);
});
...
var G__61819 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__61819;
continue;
} else {
...
var G__61820 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__61820;
continue;
} else {
var G__61821 = clojure.zip.next(loc);
loc = G__61821;
continue;
