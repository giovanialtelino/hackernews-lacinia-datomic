...
var G__43925 = (i__4737__auto___43923 + (1));
i__4737__auto___43923 = G__43925;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43742){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43778_SHARP_){
return (!((cljs.core.meta(p1__43778_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43797__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43825){var _e__41269__auto__ = e43825;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e43827){var _e__41269__auto__ = e43827;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43836 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43837 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43837);

try{var map__43864 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43864__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43836);
}});
...
var temp__5733__auto___43938 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43938)){
var managed_print_level_43939 = temp__5733__auto___43938;
var _STAR_print_level_STAR__orig_val__43903_43940 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43904_43941 = managed_print_level_43939;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43904_43941);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43899_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43899_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43903_43940);
}} else {
job_fn();
}
