...
var G__50703 = (function (){var G__50704 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__50704) : f.call(null,G__50704));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__50703) : rewrite_clj.node.coerce.call(null,G__50703));
});
/**
...
var len__4736__auto___50716 = arguments.length;
var i__4737__auto___50717 = (0);
while(true){
if((i__4737__auto___50717 < len__4736__auto___50716)){
args__4742__auto__.push((arguments[i__4737__auto___50717]));

var G__50718 = (i__4737__auto___50717 + (1));
i__4737__auto___50717 = G__50718;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__50705_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__50705_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq50706){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50707,G__50708,seq50706__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__50709 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__50709) : str_fn.call(null,G__50709));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__50710 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__50710) : str_fn.call(null,G__50710));
})()):null)));
...
var G__50713 = rewrite_clj.zip.base.tag(zloc);
var G__50713__$1 = (((G__50713 instanceof cljs.core.Keyword))?G__50713.fqn:null);
switch (G__50713__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__50711_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50711_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__50712_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50712_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50713__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__50715 = rewrite_clj.zip.base.tag(zloc);
var G__50715__$1 = (((G__50715 instanceof cljs.core.Keyword))?G__50715.fqn:null);
switch (G__50715__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__50714_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50714_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
