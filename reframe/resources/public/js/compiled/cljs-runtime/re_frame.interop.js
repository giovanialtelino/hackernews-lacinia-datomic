...
return [(function (){var pred__52817 = cljs.core.instance_QMARK_;
var expr__52818 = reactive_val;
if(cljs.core.truth_((pred__52817.cljs$core$IFn$_invoke$arity$2 ? pred__52817.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52818) : pred__52817.call(null,reagent.ratom.RAtom,expr__52818)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52817.cljs$core$IFn$_invoke$arity$2 ? pred__52817.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52818) : pred__52817.call(null,reagent.ratom.RCursor,expr__52818)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52817.cljs$core$IFn$_invoke$arity$2 ? pred__52817.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52818) : pred__52817.call(null,reagent.ratom.Reaction,expr__52818)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52817.cljs$core$IFn$_invoke$arity$2 ? pred__52817.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52818) : pred__52817.call(null,reagent.ratom.Track,expr__52818)))){
return "tr";
} else {
return "other";
}
