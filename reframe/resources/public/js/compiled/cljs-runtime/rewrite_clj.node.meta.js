...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k49724,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49724,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__49729){
var vec__49730 = p__49729;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49730,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49730,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49723){
var self__ = this;
...
var self__ = this;
var ___$1 = this;
var vec__49734 = rewrite_clj.node.protocols.sexprs(self__.children);
var mta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49734,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49734,(1),null);
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__49723){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__49749 = cljs.core.keyword_identical_QMARK_;
var expr__49750 = k__4388__auto__;
if(cljs.core.truth_((pred__49749.cljs$core$IFn$_invoke$arity$2 ? pred__49749.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__49750) : pred__49749.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__49750)))){
return (new rewrite_clj.node.meta.MetaNode(G__49723,self__.prefix,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49749.cljs$core$IFn$_invoke$arity$2 ? pred__49749.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__49750) : pred__49749.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__49750)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,G__49723,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49749.cljs$core$IFn$_invoke$arity$2 ? pred__49749.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__49750) : pred__49749.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__49750)))){
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,G__49723,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__49723),null));
}
}
}
}));
...
(rewrite_clj.node.meta.MetaNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__49723){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.meta.MetaNode(self__.tag,self__.prefix,self__.children,G__49723,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.meta.map__GT_MetaNode = (function rewrite_clj$node$meta$map__GT_MetaNode(G__49727){
var extmap__4419__auto__ = (function (){var G__49762 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__49727,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__49727)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49762);
} else {
return G__49762;
}
})();
return (new rewrite_clj.node.meta.MetaNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__49727),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__49727),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49727),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
