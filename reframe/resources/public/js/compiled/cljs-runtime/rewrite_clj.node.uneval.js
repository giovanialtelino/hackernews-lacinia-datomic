...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k49585,else__4383__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__49598){
var vec__49600 = p__49598;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49600,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49600,(1),null);
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49584){
var self__ = this;
var G__49584__$1 = this;
return (new cljs.core.RecordIter((0),G__49584__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49586,other49587){
var self__ = this;
var this49586__$1 = this;
return (((!((other49587 == null)))) && ((this49586__$1.constructor === other49587.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49586__$1.children,other49587.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49586__$1.__extmap,other49587.__extmap)));
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__49584){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__49612 = cljs.core.keyword_identical_QMARK_;
var expr__49613 = k__4388__auto__;
if(cljs.core.truth_((pred__49612.cljs$core$IFn$_invoke$arity$2 ? pred__49612.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__49613) : pred__49612.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__49613)))){
return (new rewrite_clj.node.uneval.UnevalNode(G__49584,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__49584),null));
}
}));
...
(rewrite_clj.node.uneval.UnevalNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__49584){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.uneval.UnevalNode(self__.children,G__49584,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.uneval.map__GT_UnevalNode = (function rewrite_clj$node$uneval$map__GT_UnevalNode(G__49588){
var extmap__4419__auto__ = (function (){var G__49615 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49588,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__49588)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49615);
} else {
return G__49615;
}
})();
return (new rewrite_clj.node.uneval.UnevalNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49588),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__49627 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__49627;
continue;
}
break;
