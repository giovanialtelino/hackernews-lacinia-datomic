 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$convert(p__46597,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46598__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46598__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__46600 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46600,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46600,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46600,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46603__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46604 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46604__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__46640__delegate = function (x,y,more){
...
var G__46640 = function (x,y,var_args){
var more = null;
...
while (G__46641__i < G__46641__a.length) {G__46641__a[G__46641__i] = arguments[G__46641__i + 2]; ++G__46641__i;}
  more = new cljs.core.IndexedSeq(G__46641__a,0,null);
} 
return G__46640__delegate.call(this,x,y,more);};
G__46640.cljs$lang$maxFixedArity = 2;
G__46640.cljs$lang$applyTo = (function (arglist__46642){
var x = cljs.core.first(arglist__46642);
arglist__46642 = cljs.core.next(arglist__46642);
var y = cljs.core.first(arglist__46642);
var more = cljs.core.rest(arglist__46642);
return G__46640__delegate(x,y,more);
});
...
var G__46643 = null;
if (arguments.length > 2) {
var G__46644__i = 0, G__46644__a = new Array(arguments.length -  2);
while (G__46644__i < G__46644__a.length) {G__46644__a[G__46644__i] = arguments[G__46644__i + 2]; ++G__46644__i;}
G__46643 = new cljs.core.IndexedSeq(G__46644__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46643);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46607__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46608 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46608__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__46645__delegate = function (x,y,more){
...
var G__46645 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46646__i = 0, G__46646__a = new Array(arguments.length -  2);
while (G__46646__i < G__46646__a.length) {G__46646__a[G__46646__i] = arguments[G__46646__i + 2]; ++G__46646__i;}
  more = new cljs.core.IndexedSeq(G__46646__a,0,null);
} 
return G__46645__delegate.call(this,x,y,more);};
G__46645.cljs$lang$maxFixedArity = 2;
G__46645.cljs$lang$applyTo = (function (arglist__46647){
var x = cljs.core.first(arglist__46647);
arglist__46647 = cljs.core.next(arglist__46647);
var y = cljs.core.first(arglist__46647);
var more = cljs.core.rest(arglist__46647);
return G__46645__delegate(x,y,more);
});
G__46645.cljs$core$IFn$_invoke$arity$variadic = G__46645__delegate;
return G__46645;
})()
;
...
G__46649 = new cljs.core.IndexedSeq(G__46650__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46649);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__46611 = u(x);
var map__46611__$1 = (((((!((map__46611 == null))))?(((((map__46611.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46611.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46611):map__46611);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46611__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46612 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46612__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__46651__delegate = function (x,y,more){
...
var G__46651 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__46652__i = 0, G__46652__a = new Array(arguments.length -  2);
while (G__46652__i < G__46652__a.length) {G__46652__a[G__46652__i] = arguments[G__46652__i + 2]; ++G__46652__i;}
  more = new cljs.core.IndexedSeq(G__46652__a,0,null);
} 
return G__46651__delegate.call(this,x,y,more);};
G__46651.cljs$lang$maxFixedArity = 2;
G__46651.cljs$lang$applyTo = (function (arglist__46653){
var x = cljs.core.first(arglist__46653);
arglist__46653 = cljs.core.next(arglist__46653);
var y = cljs.core.first(arglist__46653);
var more = cljs.core.rest(arglist__46653);
return G__46651__delegate(x,y,more);
});
...
var G__46654 = null;
if (arguments.length > 2) {
var G__46655__i = 0, G__46655__a = new Array(arguments.length -  2);
while (G__46655__i < G__46655__a.length) {G__46655__a[G__46655__i] = arguments[G__46655__i + 2]; ++G__46655__i;}
G__46654 = new cljs.core.IndexedSeq(G__46655__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46654);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46615__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__46616 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46616__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
...
while (G__46659__i < G__46659__a.length) {G__46659__a[G__46659__i] = arguments[G__46659__i + 2]; ++G__46659__i;}
  more = new cljs.core.IndexedSeq(G__46659__a,0,null);
} 
...
G__46661 = new cljs.core.IndexedSeq(G__46662__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__46661);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
