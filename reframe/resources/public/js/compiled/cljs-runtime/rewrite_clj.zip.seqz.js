...
var G__50723 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__50723__$1 = (((G__50723 == null))?null:cljs.core.iterate((function (loc){
...
var G__50723__$2 = (((G__50723__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50723__$1));
var G__50723__$3 = (((G__50723__$2 == null))?null:cljs.core.last(G__50723__$2));
if((G__50723__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__50723__$3);
}
} else {
return zloc;
}
...
var G__50726 = rewrite_clj.zip.move.right(v);
var G__50727 = rewrite_clj.zip.move.up(v);
loc = G__50726;
parent = G__50727;
continue;
} else {
var G__50728 = rewrite_clj.zip.move.right(v0);
var G__50729 = parent;
loc = G__50728;
parent = G__50729;
continue;
...
var G__50730 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__50731 = rewrite_clj.zip.move.up(v);
loc = G__50730;
parent = G__50731;
continue;
} else {
var G__50732 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__50733 = parent;
loc = G__50732;
parent = G__50733;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__50724 = zloc;
var G__50724__$1 = (((G__50724 == null))?null:rewrite_clj.zip.move.down(G__50724));
var G__50724__$2 = (((G__50724__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__50724__$1,k));
if((G__50724__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__50724__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__50725 = rewrite_clj.zip.move.down(zloc);
var G__50725__$1 = (((G__50725 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__50725));
if((G__50725__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50725__$1);
}
})(),k);
}
});
