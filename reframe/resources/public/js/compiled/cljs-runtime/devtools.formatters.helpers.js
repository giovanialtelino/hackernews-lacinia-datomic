...
var G__43624 = devtools.prefs.pref(v);
v = G__43624;
continue;
} else {
return v;
...
}catch (e43546){var _e__41269__auto__ = e43546;
return false;
}})();
...
}catch (e43550){var _e__41269__auto__ = e43550;
return false;
}})();
...
}catch (e43552){var _e__41269__auto__ = e43552;
return false;
}}
}
});
...
var vec__43567 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43567,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43567,(1),null);
...
return cljs.core.some((function (p1__43580_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43580_SHARP_);
}),template);
});
