...
if((c === "\n")){
var G__50352 = escape_QMARK_;
var G__50353 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__50352;
lines = G__50353;
continue;
} else {
buf.append(c);

var G__50354 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__50355 = lines;
escape_QMARK_ = G__50354;
lines = G__50355;
continue;
...
var G__50347 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__50347) : rewrite_clj.node.string_node.call(null,G__50347));
});
...
var G__50348 = cljs.core.re_pattern(regex);
var G__50349 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__50348,G__50349) : rewrite_clj.node.token_node.call(null,G__50348,G__50349));
});
