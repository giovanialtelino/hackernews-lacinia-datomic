...
var len__4736__auto___58319 = arguments.length;
var i__4737__auto___58320 = (0);
while(true){
if((i__4737__auto___58320 < len__4736__auto___58319)){
args__4742__auto__.push((arguments[i__4737__auto___58320]));

var G__58325 = (i__4737__auto___58320 + (1));
i__4737__auto___58320 = G__58325;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq58221){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58221));
}));
...
var len__4736__auto___58339 = arguments.length;
var i__4737__auto___58340 = (0);
while(true){
if((i__4737__auto___58340 < len__4736__auto___58339)){
args_arr__4757__auto__.push((arguments[i__4737__auto___58340]));

var G__58341 = (i__4737__auto___58340 + (1));
i__4737__auto___58340 = G__58341;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq58248){
var G__58249 = cljs.core.first(seq58248);
var seq58248__$1 = cljs.core.next(seq58248);
var G__58250 = cljs.core.first(seq58248__$1);
var seq58248__$2 = cljs.core.next(seq58248__$1);
var G__58251 = cljs.core.first(seq58248__$2);
var seq58248__$3 = cljs.core.next(seq58248__$2);
var G__58252 = cljs.core.first(seq58248__$3);
var seq58248__$4 = cljs.core.next(seq58248__$3);
var G__58253 = cljs.core.first(seq58248__$4);
var seq58248__$5 = cljs.core.next(seq58248__$4);
var G__58254 = cljs.core.first(seq58248__$5);
var seq58248__$6 = cljs.core.next(seq58248__$5);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58249,G__58250,G__58251,G__58252,G__58253,G__58254,seq58248__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__58285){
var vec__58287 = p__58285;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58287,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58287,(1),null);
